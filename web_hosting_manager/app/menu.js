...
export default class MenuBuilder {
  ...
  buildSimulationMenuItems() {
    const simulateMockResponse = () => {
      this.mainWindow.webContents.send('auth-response', 'safe-bmV0Lm1haWRzYWZlLmRlbW8uYXBwLndlYmhvc3Q=:AQAAAALwKXgAAAAAAAAAACAAAAAAAAAABeXvxFw5z5Ib7rBbzHt8xgvJFjmtcUxzly_tJB5tAL0gAAAAAAAAAMaGgSX27e97oVDVgTko629Tcf2bUzjRJuozleHceiCmIAAAAAAAAABh12xy3peRlMnkJQAwimEtvu_ynHVJPUN1ggUzxUvR4kAAAAAAAAAAGSZhZIVhvQY6rdF7UhArZ4RcQYTgwLTAHRDRR2hiTBRh12xy3peRlMnkJQAwimEtvu_ynHVJPUN1ggUzxUvR4iAAAAAAAAAAobAVm7sn0-WV01o1FBbX-7etzUL2mU7pogWkMpFFwVAgAAAAAAAAAKffv7VcAIpIVI2z2w9HvpujGbtRIuLHK40wM4cwmHPRAAAAAAAAAAAAAAAAAAAAAHXLPJmGUM4cmUgbD1C9y6Bxgr6VEuD9yq935PAw5kZFmDoAAAAAAAAYAAAAAAAAAKZuvBNBhA3uE46KtUYJQji6Lv7_S8v85g==');
    };
    let menu = null;
